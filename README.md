...
I'm a final-year **Bachelor of Information Technology** student at **Belgium Campus iTversity**, based in Johannesburg, South Africa. My focus spans across **Software Engineering**, **Software Development**, **Database Development**, **Web Development**, **Data Analytics**, **Business Intelligence(R Data Exploration, Data Processing, Data Warehousing, Outlier Detecton,Ehtics if Data Science, and Data Science)**, **Full-Stack Development**,  **Cloud(Docker and Kubernet)**, **Internet-of-Things( Heart Rate Anlytics Data System)**, and **Artificial Intelligence( Sti=atistics, Visualization, Data Prepartion, Classification, Regression, Clustering, Decision Tree, Support Machines, Nearal Networks) and Machine Learning** - I enjoy turning complicated requirements into clean, useful digital products.
