...
I'm a final-year **Bachelor of Information Technology** student at **Belgium Campus iTversity**, based in Johannesburg, South Africa. My focus spans across **Software Engineering( Backend Software Development, System Architectural Design, API Design, Frontend Software Development, System Testing, System Deployment)**, **Software Development**, **Database Development(Access, SQL Server Management Studio, MongoDB)**, **Web Development(HTML, CSS, Javascript)**, **Data Analytics**, **Business Intelligence(R Data Exploration, Data Processing, Data Warehousing, Outlier Detecton,Ehtics of Data Science)**, **Full-Stack Development(Frontend to Backend)**,  **Cloud(Docker and Kubernet)**, **Internet-of-Things( Heart Rate Anlytics Data System)**, and **Artificial Intelligence( Sti=atistics, Visualization, Data Prepartion, Classification, Regression, Clustering, Decision Tree, Support Machines, Nearal Networks) and Machine Learning** - I enjoy turning complicated requirements into clean, useful digital products.

I'm currently working on an **AI-Driven Heart Rate Monitoring System** while deepening my skills in **AWS Data Engineering and Python for Analytics**. If you want to chat about **C#(Object-Oriented-Pragramming)**, **C++(OOP)**, **Python(Pandas, Numpy, Matplot and seaborn)**, **R**, **HTML**, **CSS**, **Javascript**, **SQL**, **MongoDB**, **Firebase**, **Power BI**, **Data Analytics**, or **IoT**, feel free to reach out - I'm always happy to talk tech.
